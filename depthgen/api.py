...
class PRN:
    ...
    '''
    def __init__(self, is_dlib = False, is_opencv = False, prefix = './depthgen'):
        ...
        # prn_path = 'C:/Users/ADMIN/Desktop/20221/FAS/depthgen/Data/net-data/256_256_resfcn256_weight'
        if not os.path.isfile(prn_path + '.data-00000-of-00001'):
            print(prn_path + '.data-00000-of-00001')
